      ...
      <main id="main" className="industrial-page flex-grow pt-16 lg:pt-[72px]">
        ...
        {showComparison && (
          <div className="fixed inset-0 z-[60] overflow-y-auto bg-black/70 p-4" role="dialog" aria-modal="true" aria-label="Vehicle comparison">
            <div className="mx-auto mt-10 max-w-6xl border border-[var(--industrial-line)] bg-[var(--industrial-panel)] p-5 shadow-xl">
              <div className="mb-5 flex items-start justify-between gap-4">
                <div>
                  <p className="text-xs font-bold uppercase tracking-[.12em] text-[var(--industrial-accent)]">Selected vehicles</p>
                  <h2 className="mt-1 text-3xl font-extrabold uppercase text-[var(--industrial-text)]">Compare specifications</h2>
                </div>
