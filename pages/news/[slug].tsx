...
export default function NewsDetailPage({ item, previous, next, related }: { item: NewsItem; previous: NewsItem | null; next: NewsItem | null; related: NewsItem[] }) {
  ...
  return <><Head><title>{item.seoTitle}</title><meta name="description" content={item.seoDescription} /><meta property="og:title" content={item.seoTitle} /><meta property="og:description" content={item.seoDescription} /><meta property="og:image" content={item.image} /><meta property="og:type" content="article" /><meta property="article:published_time" content={item.date} /><meta name="twitter:card" content="summary_large_image" /></Head><Header />
